...
export class AppService {
  ...
  getAutoComplete(Keyword:string): Observable<any>{
    ...
    const url = 'https://backendangular-412708.uw.r.appspot.com/getautocomplete';
  ...
  getEbayData(keyword: string, category: string, condition: string[], shipping: string[], distance: string, zipCode: string): Observable<any> {
    ...
    const url = 'https://backendangular-412708.uw.r.appspot.com/getebaydata'
    let params = {
      keyword,
      category,
      condition,
  ...
  getEbayDetails(itemId: string): Observable<any> {
    ...
    const url = 'https://backendangular-412708.uw.r.appspot.com/singledata'
    let params = {
      itemId
    };
    let queryParams = new HttpParams({ fromObject: params });
  ...
  getPhotos(keyword: string): Observable<any> {
    ...
    const url = 'https://backendangular-412708.uw.r.appspot.com/getphotos'
    let params = {
      keyword
    };
    let queryParams = new HttpParams({ fromObject: params });
  ...
  getEbaySimilarItems(itemId: string): Observable<any> {
    ...
    const url = 'https://backendangular-412708.uw.r.appspot.com/similardata';
    let params = {
      itemId
    };
    let queryParams = new HttpParams({ fromObject: params });
  ...
  pushToWishlist(item: any): Observable<any> {
    ...
    const url = 'https://backendangular-412708.uw.r.appspot.com/wishlist';
    const itemData = { 
  ...
  removeFromWishlist(itemId: string): Observable<any> {
    ...
    const url = `https://backendangular-412708.uw.r.appspot.com/wishlist/${itemId}`;
    return this.http.delete<any>(url);
  }

  getWishlistIds(): Observable<string[]> {
    // const url = 'http://localhost:3000/wishlist/ids';
    const url = 'https://backendangular-412708.uw.r.appspot.com/wishlist/ids';
